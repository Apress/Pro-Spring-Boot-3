...
public class UsersController {
    ...
    public ResponseEntity<String> getGravatarByEmail(@PathVariable String email) throws Throwable {
        return ResponseEntity.ok(this.userRepository.getGravatarByEmail(email));
    }

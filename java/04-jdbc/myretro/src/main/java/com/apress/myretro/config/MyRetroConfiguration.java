        ...
        return applicationReadyEvent -> {
            ...
            RetroBoard retroBoard = RetroBoard.builder()
                    ...
                    .name("Spring Boot Conference")
                            ...
                            .card(UUID.fromString("f9de7f11-5393-4b5b-8e9d-10eca5f50189"),Card.builder().id(UUID.fromString("f9de7f11-5393-4b5b-8e9d-10eca5f50189")).comment("Meet everyone in person").cardType(CardType.HAPPY).build())
                            .card(UUID.fromString("6cdb30d6-43f2-42b7-b0db-f3acbc53d467"),Card.builder().id(UUID.fromString("6cdb30d6-43f2-42b7-b0db-f3acbc53d467")).comment("When is the next one?").cardType(CardType.MEH).build())
                            .card(UUID.fromString("9de1f7f9-2470-4c8d-86f2-371203620fcd"),Card.builder().id(UUID.fromString("9de1f7f9-2470-4c8d-86f2-371203620fcd")).comment("Not enough time to talk to everyone").cardType(CardType.SAD).build())
                    .build();
